"""
Django settings for spac_platform project.
...
if os.environ.get('SETTINGS') == 'dev':
    ...
    DEBUG = False
    ALLOWED_HOSTS = ['registration.spac25.ieeensusb.org']
...
ROOT_URLCONF = 'spac_platform.urls'
...
WSGI_APPLICATION = 'spac_platform.wsgi.application'
